const {ipcRenderer, clipboard, nativeImage, remote} = window.require('electron')
const fs = window.require('fs')
const { getScreenSources } = window.require('./desktop-capturer')
const { CaptureEditor } = window.require('./capture-editor')
